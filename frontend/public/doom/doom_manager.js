...
function showSuccess() {
    ...
    // Notify the parent React app (see components/DoomCaptcha.tsx) that the
    // captcha was solved, so it can proceed with the skin upload.
    window.parent.postMessage({ type: "doom-captcha-solved" }, "*");
